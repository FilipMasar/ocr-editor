...
const PanelOptions: FC = () => {
  ...
  const onStartOver = (e: MouseEvent<HTMLButtonElement>) => {
    ...
    if (
      window.confirm(
        'Are you sure you want to start over? All changes will be lost.'
      )
    ) {
      setAlto(undefined);
              ...
              {fontColors.map((color) => (
                <div
                  ...
                  className={`w-4 h-4 rounded-full ${color} cursor-pointer ${
                    styles[key].color === color && 'border-4 border-black'
                  }`}
                  onClick={() => {
                    setStyles((old) => ({
                      ...old,
                      [key]: {
                        ...old[key],
                        color: old[key].color === color ? undefined : color,
                      },
                    }));
                    setSettings((old) => ({
                      ...old,
                      show: { ...old.show, strings: true },
                    }));
                  }}
                />
              ))}
          ...
          <div className="flex gap-4 ml-2">
            ...
            <input
              ...
              onChange={(e) =>
                setStyles((old) => ({
                  ...old,
                  [key]: { ...old[key], fontSize: parseInt(e.target.value) },
                }))
              }
            />
          </div>
          <div className="flex gap-4 ml-2 mt-2">
            ...
            <input
              ...
              onChange={(e) =>
                setStyles((old) => ({
                  ...old,
                  [key]: { ...old[key], fontFamily: e.target.value },
                }))
              }
            />
          </div>
        ...
        <div className="flex items-center gap-2">
          <input
            ...
            onChange={(e) =>
              setSettings((old) => ({
                ...old,
                show: { ...old.show, printSpace: e.target.checked },
              }))
            }
          />
        ...
        <div className="flex items-center gap-2">
          <input
            ...
            onChange={(e) =>
              setSettings((old) => ({
                ...old,
                show: { ...old.show, illustrations: e.target.checked },
              }))
            }
          />
        ...
        <div className="flex items-center gap-2">
          <input
            ...
            onChange={(e) =>
              setSettings((old) => ({
                ...old,
                show: { ...old.show, graphicalElements: e.target.checked },
              }))
            }
          />
        ...
        <div className="flex items-center gap-2">
          <input
            ...
            onChange={(e) =>
              setSettings((old) => ({
                ...old,
                show: { ...old.show, textBlocks: e.target.checked },
              }))
            }
          />
        ...
        <div className="flex items-center gap-2">
          <input
            ...
            onChange={(e) =>
              setSettings((old) => ({
                ...old,
                show: { ...old.show, textLines: e.target.checked },
              }))
            }
          />
        ...
        <div className="flex items-center gap-2">
          <input
            ...
            onChange={(e) =>
              setSettings((old) => ({
                ...old,
                show: { ...old.show, strings: e.target.checked },
              }))
            }
          />
          <label>Strings</label>
        ...
        <div className="flex items-center gap-2">
          <input
            ...
            onChange={(e) =>
              setSettings((old) => ({
                ...old,
                show: { ...old.show, textFit: e.target.checked },
              }))
            }
          />
        ...
        <div className="flex items-center gap-2">
          <input
            ...
            onChange={(e) =>
              setSettings((old) => ({
                ...old,
                show: { ...old.show, textAbove: e.target.checked },
              }))
            }
          />
